...
<body class="d-flex flex-column h-100">
    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Panggilan Antrian Dukcapil - Loket 2</h1>
        </div>
        <!-- breadcrumbs -->
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  <p id="jumlah-antrian-dukcapil" class="fs-3 text-warning mb-1"></p>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  <p id="antrian-sekarang-dukcapil" class="fs-3 text-success mb-1"></p>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  <p id="antrian-selanjutnya-dukcapil" class="fs-3 text-info mb-1"></p>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  <p id="sisa-antrian-dukcapil" class="fs-3 text-danger mb-1"></p>
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
          <div class="table-responsive">
            <table id="tabel-antrian-dukcapil" class="table table-bordered table-striped table-hover" width="100%">
              <thead>
                <tr>
                  <th>Nomor Antrian</th>
                  <th>Status</th>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2023 - <a href="" target="_blank" class="text-danger text-decoration-none">farhan</a>. All rights reserved.
      </div>
    </div>
  </footer>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#jumlah-antrian-dukcapil').load('get_jumlah_antrian_dukcapil.php');
      $('#antrian-sekarang-dukcapil').load('get_antrian_sekarang_dukcapil.php');
      $('#antrian-selanjutnya-dukcapil').load('get_antrian_selanjutnya_dukcapil.php');
      $('#sisa-antrian-dukcapil').load('get_sisa_antrian_dukcapil.php');

      // menampilkan data antrian menggunakan DataTables
      var table = $('#tabel-antrian-dukcapil').DataTable({
        "lengthChange": false,              // non-aktifkan fitur "lengthChange"
        "searching": false,                 // non-aktifkan fitur "Search"
        "ajax": "get_antrian_dukcapil.php",          // url file proses tampil data dari database
        // menampilkan data
        "columns": [{
            "data": "no_antrian_dukcapil",
            "width": '250px',
      ...
      $('#tabel-antrian-dukcapil tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian_dukcapil"] + ", menuju, loket, 2", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
        ...
        $.ajax({
          ...
          url: "update_dukcapil.php",          // url file proses update data
      ...
      setInterval(function() {
        $('#jumlah-antrian-dukcapil').load('get_jumlah_antrian_dukcapil.php').fadeIn("slow");
        $('#antrian-sekarang-dukcapil').load('get_antrian_sekarang_dukcapil.php').fadeIn("slow");
        $('#antrian-selanjutnya-dukcapil').load('get_antrian_selanjutnya_dukcapil.php').fadeIn("slow");
        $('#sisa-antrian-dukcapil').load('get_sisa_antrian_dukcapil.php').fadeIn("slow");
